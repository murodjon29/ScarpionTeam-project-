...
export class VideosOfTeachersController {
  constructor(private readonly videosOfTeachersService: VideosOfTeachersService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateVideosOfTeacherDto: UpdateVideosOfTeacherDto) {
