...
export class VideosofprojectsController {
  constructor(private readonly videosofprojectsService: VideosOfProjectsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateVideosofprojectDto: UpdateVideosofprojectDto) {
